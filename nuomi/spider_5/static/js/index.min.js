...
var _vueSocket = __webpack_require__(9);

var _vueSocket2 = _interopRequireDefault(_vueSocket);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_vue2.default.use(_vueSocket2.default, 'http://127.0.0.1:8080');
...
var app = new _vue2.default({
    ...
    computed: {
        ...
        processVal: function processVal() {
    ...
    sockets: {
        ...
        started: function started(res) {
            res.dataList.forEach(function (each) {
                if (each.pic) {
                    var picArr = each.pic.split('/').slice(-2);
